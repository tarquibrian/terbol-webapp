            ...
            {product.extraImages && product.extraImages.length > 0 && (
              <AnimateOnScroll variant="fade" delay={0.2}>
                <div className="flex gap-4 overflow-x-auto pb-4 snap-x no-scrollbar">
                  {[
                    product.cardImage,
                    ...product.extraImages.filter(
                      (img) => img !== product.cardImage,
                    ),
                  ].map((img, idx) => {
                    const isSelected =
                      (selectedImage ?? product.cardImage) === img;
                    return (
                      <button
                        key={idx}
                        onClick={() => setSelectedImage(img)}
                        className={`relative shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-md overflow-hidden bg-primary-soft-gray-balance snap-center border transition-all duration-200 ${
                          isSelected
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex gap-4 lg:gap-8 justify-between">
              ...
              <AnimateOnScroll variant="slide-up" delay={0.5}>
                <div className="text-body-md text-gray-500 mb-2">
                  Disponibilidad
                </div>
            ...
            {/*       Serás redirigido a la tienda oficial de Térbol para completar */}
            ...
            {product.usageInstructions && (
              <>
                ...
                >
                  <h2 className="heading-h5 text-gray-900 font-bold">
                    Modo de uso
                  </h2>
