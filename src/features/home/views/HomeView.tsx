...
export interface HomePageData {
  ...
  featured_focuses?: HomeFeaturedFocus[];
}
 ...
 */
export async function HomeView({ data }: HomeViewProps) {
  const featuredProducts = mapHomeFeaturedProducts(data?.featured_products);
  const focusCategories = mapHomeFeaturedFocuses(data?.featured_focuses);
