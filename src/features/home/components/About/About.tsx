...
export const About = () => {
  return (
    <section className="w-full">
      <div className="container max-w-[1512px] mx-auto py-12 px-16">
        <div className="bg-primary-soft-gray-balance m-full max-w-[1200px] mx-auto p-3 rounded-lg">
          <AnimateOnScroll variant="slide-up">
            <div className="flex flex-col gap-4 py-8 max-w-[770px] mx-auto">
              ...
              <p className="text-center text-body text-gray-500">Térbol Inspira es la línea premium de vitaminas y nutracéuticos de Térbol, desarrollada con formulaciones respaldadas por evidencia científica. Nacimos para ofrecer productos de alta gama a quienes no se conforman con menos cuando se trata de su salud.</p>
            </div>
          </AnimateOnScroll>
